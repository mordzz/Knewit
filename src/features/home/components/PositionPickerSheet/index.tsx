 ...
 * from something the user actually holds client-side too. The backend
 * still independently re-verifies ownership and re-fetches the position
 * itself before writing the snapshot — this list is for selection UX
 * only, never trusted as the snapshot's source of truth — see
 * docs/DECISIONS.md.
 */
