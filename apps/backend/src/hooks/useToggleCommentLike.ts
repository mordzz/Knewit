...
import { likeComment, unlikeComment } from '@/lib/commentService';
...
export function useToggleCommentLike() {
  ...
  return useMutation({
    mutationFn: ({ commentId, liked }: ToggleCommentLikeInput) => (liked ? unlikeComment(commentId) : likeComment(commentId)),
