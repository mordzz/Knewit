...
import { getFollowSuggestions } from '@/features/profile/services/userService';

/**
 * Follow suggestions for the tablet "Who to follow" rail — five per page,
 * with "Show more" fetching the next page (docs/DECISIONS.md, "Follow
